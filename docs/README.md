...
This folder organizes the public-facing material for the INDI hybrid UAV
research project.
...
Full source code, tuning files, raw logs and third-party papers are intentionally
